...
def save_model(iter):
    if not os.path.exists('models_origin/'):
        os.makedirs('models_origin/')
    torch.save(dismodel.state_dict(), 'models_origin/cls_model_{}'.format(iter))
