...
data_path = './data'
train_path = '2_train.csv'
valid_path = '2_valid.csv'
...
"""text"""
train_loader.readTxt(path=data_path, data_path=train_path)
test_loader.readTxt(path=data_path, data_path=valid_path)
...
model_pt_path = f'./models/{model_name}/s2sAttn_syl_gs_110_128_128_E9T3V13.pt'
